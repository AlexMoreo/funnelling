...
def fetch_RCV2(data_path=None, languages=None):

    def parse_document(xml_content, assert_lang=None):
...
if __name__=='__main__':
    ...
    rcv1_documents, labels1 = fetch_RCV1(RCV1_PATH, split='train')
    rcv2_documents, labels2 = fetch_RCV2(RCV2_PATH, RCV2_LANGS_WITH_NLTK_STEMMING)

    print('read {} documents in rcv1, and {} labels'.format(len(rcv1_documents), len(labels1)))
